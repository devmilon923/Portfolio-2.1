export const PERSONAL = {
  ...
  upwork: 'https://www.upwork.com/freelancers/~01bd608f5c07cb250e?mp_source=share',
  resumeUrl: '#',
};

export const STATS = [
  { label: 'Years of Experience', value: 1, suffix: '+', description: 'Professional development experience' },
  { label: 'Projects Delivered', value: 15, suffix: '+', description: 'Full-stack applications shipped' },
  { label: 'API Performance Boost', value: 40, suffix: '%', description: 'Achieved via optimization & caching' },
  { label: 'International Clients', value: 5, suffix: '+', description: 'Across multiple countries' },
];
...
export const PROJECTS = [
  {
    ...
    technologies: ['Next.js', 'Node.js', 'PostgreSQL', 'Prisma', 'Redis', 'BullMQ', 'React', 'TypeScript'],
  ...
  },
  {
    ...
    technologies: ['Node.js', 'TypeScript', 'OpenAI API', 'Pinecone', 'RAG Architecture', 'Redis', 'BullMQ', 'MongoDB'],
    liveUrl: null,
  ...
  },
  {
    ...
    technologies: ['Node.js', 'Express.js', 'MongoDB', 'Redis', 'Docker', 'AWS EC2', 'GitHub Actions', 'Nginx'],
    liveUrl: null,
    sourceUrl: null,
...
export const TECH_STACK = [
  // Frontend
  { name: 'React', category: 'frontend', usage: 'Building component-driven UIs with hooks and state management', icon: '⚛️' },
  { name: 'Next.js', category: 'frontend', usage: 'Full-stack React apps with SSR, API routes, and app router', icon: '▲' },
  { name: 'TypeScript', category: 'frontend', usage: 'Strongly typed codebases for safer, more maintainable code', icon: 'TS' },
  { name: 'JavaScript', category: 'frontend', usage: 'Core language for both client and server-side development', icon: 'JS' },
  { name: 'Tailwind CSS', category: 'frontend', usage: 'Utility-first styling for rapid, consistent UI development', icon: '🎨' },
  { name: 'React Query', category: 'frontend', usage: 'Server-state management, caching, and async data fetching', icon: 'RQ' },
  { name: 'Shadcn UI', category: 'frontend', usage: 'Accessible component library for production-ready UIs', icon: '◻' },
  { name: 'Framer Motion', category: 'frontend', usage: 'Declarative animations and gesture interactions for React', icon: '✦' },

  // Backend
  { name: 'Node.js', category: 'backend', usage: 'High-performance server runtime for scalable APIs', icon: '🟢' },
  { name: 'Express.js', category: 'backend', usage: 'Minimal web framework for building REST APIs', icon: 'Ex' },
  { name: 'Socket.IO', category: 'backend', usage: 'Real-time bidirectional communication for live features', icon: '⚡' },
  { name: 'BullMQ', category: 'backend', usage: 'Reliable job queues for async background processing', icon: '📋' },
  { name: 'GraphQL', category: 'backend', usage: 'Flexible query language for data-driven APIs', icon: '◉' },
  { name: 'PostgreSQL', category: 'backend', usage: 'Relational database with complex query and indexing needs', icon: '🐘' },
  { name: 'MongoDB', category: 'backend', usage: 'Flexible document store for dynamic, schema-free data', icon: '🍃' },
  { name: 'Redis', category: 'backend', usage: 'In-memory caching, session store, and pub/sub messaging', icon: '🔴' },
  { name: 'Prisma', category: 'backend', usage: 'Type-safe ORM for PostgreSQL with migration management', icon: '◇' },
  { name: 'Pinecone', category: 'backend', usage: 'Vector database for semantic search and RAG systems', icon: '🔍' },
  { name: 'OpenAI API', category: 'backend', usage: 'LLM integration for AI features, embeddings, and RAG', icon: '🤖' },

  // Deployment
  { name: 'AWS EC2', category: 'deployment', usage: 'Provisioning and managing production Linux servers', icon: '☁️' },
  { name: 'Docker', category: 'deployment', usage: 'Containerizing applications for consistent deployments', icon: '🐳' },
  { name: 'Nginx', category: 'deployment', usage: 'Reverse proxy, load balancing, and SSL termination', icon: '⚙️' },
  { name: 'GitHub Actions', category: 'deployment', usage: 'Automated CI/CD pipelines for zero-touch deployments', icon: '🔄' },
  { name: 'Vercel', category: 'deployment', usage: 'Zero-config deployment platform for Next.js projects', icon: '▲' },
  { name: 'Linux', category: 'deployment', usage: 'Server administration, shell scripting, and production environment management', icon: '🐧' },
];

export const STRENGTHS = [
  {
    title: 'System Architecture',
    description: 'Designing scalable backend systems from schema to deployment with performance baked in from day one.',
  },
  {
    title: 'AI Integration',
    description: 'Building RAG pipelines, embedding systems, and semantic search that make products genuinely intelligent.',
  },
  {
    title: 'API Performance',
    description: 'MongoDB tuning, Redis caching, and query optimization that measurably cut response times.',
  },
  {
    title: 'Production Deployment',
    description: 'Docker, Nginx, AWS EC2, and GitHub Actions CI/CD — automated, reliable, and repeatable.',
  },
];
