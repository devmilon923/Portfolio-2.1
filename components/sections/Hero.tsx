...
import { ArrowDown, Github, Linkedin, Mail, Sparkles, Zap, Server, Brain } from 'lucide-react';
...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-void pt-16"
    >
      {/* Background elements */}
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <p className="text-ash text-[11px] font-light mt-0.5">{card.sub}</p>
              </div>
            </motion.div>
          </motion.div>
        ))}
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          <span className="text-cream text-xs font-light tracking-wide">Available for freelance work</span>
        ...
        >
          Full-Stack Developer with 1+ year at an international agency — shipping AI-integrated platforms,
          scalable APIs, and automated infrastructure for clients across the globe.
        </motion.p>
