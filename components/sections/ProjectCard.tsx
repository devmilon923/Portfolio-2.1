      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10">
        ...
        <div className="lg:col-span-5 flex flex-col justify-between space-y-6">
          <div className="space-y-5">
            ...
            {project.metricLabel && (
              <div className="rounded-xl p-4 bg-paper-white/80 border border-iron/60 shadow-xs hover:border-obsidian/40 hover:shadow-xs transition-all duration-200 space-y-1.5">
          ...
          {/* Action Links */}
          <div className="flex flex-wrap items-center gap-2.5 sm:gap-3 pt-4 border-t border-obsidian/8">
            {project.liveUrl && (
              <a
                ...
                className="group/btn inline-flex items-center justify-center gap-1.5 sm:gap-2 px-4 py-2.5 sm:px-6 sm:py-3 min-h-[38px] sm:min-h-[44px] rounded-full bg-obsidian text-paper-white text-[11px] sm:text-xs font-semibold hover:bg-deep-teal transition-colors duration-200 shadow-sm"
              >
                <ExternalLink className="w-3.5 h-3.5 sm:w-4 sm:h-4 flex-shrink-0 transition-transform duration-200 group-hover/btn:translate-x-0.5" />
                <span>Live Demo</span>
              </a>
            )}
            {project.sourceUrl && (
              <a
                ...
                className="group/btn inline-flex items-center justify-center gap-1.5 sm:gap-2 px-4 py-2.5 sm:px-6 sm:py-3 min-h-[38px] sm:min-h-[44px] rounded-full border border-obsidian/20 bg-paper-white/90 text-obsidian text-[11px] sm:text-xs font-semibold hover:bg-paper-white hover:border-obsidian/40 transition-colors duration-200 shadow-2xs"
              >
                <Github className="w-3.5 h-3.5 sm:w-4 sm:h-4 flex-shrink-0 transition-transform duration-200 group-hover/btn:translate-x-0.5" />
                <span>Source Code</span>
              </a>
            )}
            {!project.liveUrl && !project.sourceUrl && (
              <span className="inline-flex items-center gap-1.5 sm:gap-2 px-3.5 py-2 sm:px-5 sm:py-2.5 rounded-full bg-paper-white/80 border border-obsidian/15 text-obsidian/85 text-[11px] sm:text-xs font-medium backdrop-blur-xs">
                <ShieldAlert
                  className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-emerald-600 flex-shrink-0"
                  aria-hidden="true"
                />
        ...
        <div className="lg:col-span-7 space-y-4">
          ...
          <button
            ...
            className="w-full flex items-center justify-between px-3.5 py-2.5 sm:px-4 sm:py-3 min-h-[38px] sm:min-h-[44px] rounded-xl bg-paper-white/80 border border-iron/60 hover:bg-paper-white hover:border-obsidian/40 text-[11px] sm:text-xs font-semibold text-obsidian/90 transition-colors duration-200 shadow-xs"
          >
